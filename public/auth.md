...
Examples use placeholder hosts: `https://alexgetman.com` (the resource server hosting the API you want to call) and `https://alexgetman.com` (the authorization server that handles registration). Real services substitute their own.
...
WWW-Authenticate: Bearer resource_metadata="https://alexgetman.com/.well-known/oauth-protected-resource"
```
...
```json
{
  "resource": "https://alexgetman.com/",
  "resource_name": "Service",
  "resource_logo_uri": "https://alexgetman.com/logo.png",
  "authorization_servers": ["https://alexgetman.com/"],
...
```json
{
  ...
  "issuer": "https://alexgetman.com",
  "token_endpoint": "https://alexgetman.com/oauth2/token",
  "revocation_endpoint": "https://alexgetman.com/oauth2/revoke",
  ...
  "agent_auth": {
    "skill": "https://alexgetman.com/auth.md",
    "identity_endpoint": "https://alexgetman.com/agent/identity",
    "claim_endpoint": "https://alexgetman.com/agent/identity/claim",
    "events_endpoint": "https://alexgetman.com/agent/event/notify",
...

{
  ...
  "registration_id": "reg_...",
  "registration_type": "identity_assertion",
  "claim_url": "https://alexgetman.com/agent/identity/claim",
  "claim_token": "clm_...",
  "claim_token_expires": "…",
  ...
  "claim": {
    "user_code": "123456",
    "expires_in": 600,
    "verification_uri": "https://alexgetman.com/login?return_to=%2Fclaim%3Fclaim_attempt_token%3D...",
    "interval": 5
  }
}
```
...
> https://alexgetman.com/login?return_to=...
...
Full API reference: `https://docs.alexgetman.com/`.
